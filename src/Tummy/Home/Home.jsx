...
import Pregent3 from '../../Images/Pregent3.jpg';
...
import Pregent15 from '../../Images/Pregent15.jpg';
...
function Home() {
  ...
  const slides = [
    { id: 1, title: "Slide 1", image: Pregent4 },
    { id: 2, title: "Slide 2", image: Pregent7 },
    { id: 3, title: "Slide 3", image: Pregent3 },
    { id: 4, title: "Slide 4", image: Pregent8 },
  ];
...
{slide.id === 3 && (
                <div className='Slider-img2'>
                  <img src={Pregent12} alt='Pregnant Woman Reflecting' />
                </div>
              )}
...
{slide.id === 4 && (
                ...
                <p>Pregnancy is a beautiful journey that should be cherished. For South Asians in the United States, medical care and cultural practices often feel poles apart – we bridge that gap for you. By blending South Asian heritage with Western medicine, we create a seamless and supportive experience.
...
We offer guidance that blends both worlds, ensuring that no sort of dialogue gets lost. You can expect a touch of familiarity within each step of your special chapter. All you have to do is focus on growing your family.
      ...
      <p className='hear-text'>Moving to a new country itself presents countless challenges, yet the unique experiences of pregnant women navigating this transition often go unnoticed.
...
TummyTales was born from our own experiences of seeking guidance and support while finding our footing in a new country. We understand the importance of feeling heard and having a space to ask questions without fear or hesitation.</p>
